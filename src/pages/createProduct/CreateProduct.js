...
export function CreateProduct() {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            console.log(data)
            // const temp = await productService.saveProduct(data);
                    ...
                    <form className="form-operation" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {categorySelect !== null ?
                            <div className="form-element">
                                ...
                                <select id="productFamilySelect" {...register("brand")}>
                                    ...
                                    <div key={index} className="price-of-product">
                                        ...
                                        <select {...register(`pricingList[${index}].color`)}
                                            ...
                                            {colors && colors.map((color) => (
                                                <option key={color.colorId} value={JSON.stringify(color)}>{color.colorName}</option>
                                            ))}
                                        </select>
                                        ...
                                        <select {...register(`pricingList[${index}].promotion`)}
                                            ...
                                            {promotions && promotions.map((item) => (
                                                <option key={item.promotionId} value={JSON.stringify(item)}>{item.promotionName}</option>
                                            ))}
                                        </select>
